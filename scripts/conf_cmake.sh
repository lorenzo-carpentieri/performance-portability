...
cmake -E env HIPSYCL_TARGETS=cuda:sm_70 cmake .. -DDEBUG=1 -DCMAKE_CXX_COMPILER=syclcc -DKERNEL_PROFILING=1 -DSYCL_BACKEND="hipSYCL" -DSYCL_DEVICE=gpu -DCMAKE_CXX_FLAGS='-O3 -fno-omit-frame-pointer -fno-optimize-sibling-calls' 
